    ...
    <div className="grid md:grid-cols-4 gap-6 mb-8">
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-muted-foreground">Actively Present</div>
            </div>
      ...
      <Card className="bg-card/70 backdrop-blur-sm shadow-lg">
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{studentLeadsPresent}</div>
              <div className="text-muted-foreground">Student Leads Present</div>
            </div>
