...
export function PublicDashboard({
  ...
  const clockedInUsers = staffData.filter(
    (staff) => staff.currentStatus === 'present'
  );
  const expectedArrivals = staffData.filter(
    (staff) => staff.currentStatus === 'expected'
  );
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-600 text-sm">
                IT Service Desk Clock-In System
              </p>
            </div>
          </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Swipe your ID card to clock in or out automatically
                </p>
                <p className="text-sm text-slate-500 mt-1">
                  Or use manual clock in for backup
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="mt-8 bg-slate-50 border-slate-200">
          <CardContent className="p-4">
            ...
            <div className="text-sm text-slate-600 space-y-1">
              <p>
                • Type "CARD001", "CARD002", "CARD003", "CARD004", "CARD005", or
                "CARD006" and press Enter to simulate card swipe
              </p>
              <p>• Use Manual Clock In for backup entry</p>
              <p>• Admin Login: username "admin", password "admin123"</p>
              <p>
                • Location assignment happens automatically after clock-in
